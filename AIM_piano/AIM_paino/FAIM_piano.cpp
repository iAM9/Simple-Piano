...
ALuint Buffer_D, Source_D;		//ALuint Buffer;			
...
ALboolean LoadALData()
{
	...
	{
		MessageBox(0,"Can't create Buffer_C!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/C.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_C!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_C_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_C_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_D!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/D.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_D!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_D_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_D_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_E!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/E(1).wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_E!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_F!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/F.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_F!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_F_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_F_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_G!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/G.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_G!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_G_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_G_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_A!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/A.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_A!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_A_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_A_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_B!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/B.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_B!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_C1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/C+1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_C1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_C_1!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_C_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_C_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_C_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_D_1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/D-1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_D_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_D_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_D_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_E_1!","Error",MB_OK);
	}
 ...
 if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_E_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_F_1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/F-1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_F_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_F_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_F_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_G_1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/G-1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_G_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_G_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_G_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_A_1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/A-1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_A_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_A_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_A_1_sharp!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_B_1!","Error",MB_OK);
	}

	alutLoadWAVFile("C:/AIM_piano/piano_final_wave/B-1.wav",&format,&data,&size,&freq,&loop);
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_B_1!","Error",MB_OK);
	}
	...
	if(alGetError() != AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Buffer_B_1_1!","Error",MB_OK);
	}
	...
	if(alGetError == AL_NO_ERROR)
	{
		MessageBox(0,"Can't create Source_B_1_1!","Error",MB_OK);
	}
...
{
	MessageBox(0, "Welcome to the 5th IT & Engineering Fair","AIM's Piano",MB_OK);
	MessageBox(0, "Project Members: \n\nIbrahim Asif Mirza (Project Leader)\nMubbashir Shakil\nAmir Jehangir","AIM's Piano",MB_OK);
	...
	{
		MessageBox(0,"Can't load from LoadALData()","Error",MB_OK);
	}
	...
	{
		MessageBox(0,"Can not register window!","Error!",MB_OK | MB_ICONERROR);
	}
	
	window = CreateWindow("win","Piano",WS_VISIBLE | WS_SYSMENU,400,320,487,173,0,0,hi,0);
	
	if(!window)
	{
		MessageBox(0,"Can not create window", "Error!",MB_OK|MB_ICONERROR);
	}
	...
	/*black = CreateWindow("BUTTON","C#   D#    F#  G#  A#",WS_VISIBLE ,400,250,500,100,0,0,hi,0);
	ShowWindow(black, i);*/
								...
								///////  MIDDLE C KEYS ////////////////////
								///////////////////////////////////////////
	key_C_sharp = CreateWindow("BUTTON","C#",WS_CHILD |WS_CLIPCHILDREN|BS_BITMAP  ,255,0,25,75,window,0,hi,0);
				hBmp_key_C_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_C_sharp,BM_SETIMAGE, IMAGE_BITMAP, (LPARAM)hBmp_key_C_sharp);
				ShowWindow(key_C_sharp,i);

	key_D_sharp = CreateWindow("BUTTON","D#",WS_CHILD |WS_CLIPCHILDREN|BS_BITMAP  ,285,0,25,75,window,0,hi,0);
				hBmp_key_D_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_D_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_D_sharp);
				ShowWindow(key_D_sharp,i);

	key_F_sharp = CreateWindow("BUTTON","F#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,345,0,25,75,window,0,hi,0);
				hBmp_key_F_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_F_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_F_sharp);
				ShowWindow(key_F_sharp,i);

	key_G_sharp = CreateWindow("BUTTON","G#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,375,0,25,75,window,0,hi,0);
				hBmp_key_G_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_G_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_G_sharp);
				ShowWindow(key_G_sharp,i);

	key_A_sharp = CreateWindow("BUTTON","A#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,405,0,25,75,window,0,hi,0);
				hBmp_key_A_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_A_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_A_sharp);
				ShowWindow(key_A_sharp,i);
	

		key_C = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,240,0,30,130,window,0,hi,0);
				hBmp_key_C = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_C,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_C);
				ShowWindow(key_C,i);

		key_D = CreateWindow("BUTTON","\nD",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,270,0,30,130,window,0,hi,0);
				hBmp_key_D = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_D,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_D);
				ShowWindow(key_D,i);

		key_E = CreateWindow("BUTTON","\nE",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,300,0,30,130,window,0,hi,0);
		hBmp_key_E = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_E,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_E);
				ShowWindow(key_E,i);

		key_F = CreateWindow("BUTTON","\nF",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,330,0,30,130,window,0,hi,0);
		hBmp_key_F = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_F,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_F);
				ShowWindow(key_F,i);

		key_G = CreateWindow("BUTTON","\nG",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,360,0,30,130,window,0,hi,0);
		hBmp_key_G = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_G,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_G);
				ShowWindow(key_G,i);

		key_A = CreateWindow("BUTTON","\nA", BS_BITMAP | WS_CHILD | WS_CLIPSIBLINGS,390,0,30,130,window,0,hi,0);
		hBmp_key_A = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_A,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_A);
				ShowWindow(key_A,i);

		key_B = CreateWindow("BUTTON","\nB",BS_BITMAP | WS_CHILD | WS_CLIPSIBLINGS,420,0,30,130,window,0,hi,0);
		hBmp_key_B = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_B,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_B);
				ShowWindow(key_B,i);


	    key_C1 = CreateWindow("BUTTON","C",BS_BITMAP | WS_CHILD | WS_CLIPSIBLINGS,450,0,30,130,window,0,hi,0);
		hBmp_key_C1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				...
				ShowWindow(key_C1,i);
					//////////////////////////////////////////
						...
						//////////////////////////////////////////
								///////  LOWER OCTAVE KEYS ////////////////////
								///////////////////////////////////////////
	key_C_1_sharp = CreateWindow("BUTTON","C#",WS_CHILD |WS_CLIPCHILDREN|BS_BITMAP  ,45,0,25,75,window,0,hi,0);
				hBmp_key_C_1_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_C_1_sharp,BM_SETIMAGE, IMAGE_BITMAP, (LPARAM)hBmp_key_C_1_sharp);
				ShowWindow(key_C_1_sharp,i);

	key_D_1_sharp = CreateWindow("BUTTON","D#",WS_CHILD |WS_CLIPCHILDREN|BS_BITMAP  ,75,0,25,75,window,0,hi,0);
				hBmp_key_D_1_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_D_1_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_D_1_sharp);
				ShowWindow(key_D_1_sharp,i);

	key_F_1_sharp = CreateWindow("BUTTON","F#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,135,0,25,75,window,0,hi,0);
				hBmp_key_F_1_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_F_1_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_F_1_sharp);
				ShowWindow(key_F_1_sharp,i);

	key_G_1_sharp = CreateWindow("BUTTON","G#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,165,0,25,75,window,0,hi,0);
				hBmp_key_G_1_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_G_1_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_G_1_sharp);
				ShowWindow(key_G_1_sharp,i);

	key_A_1_sharp = CreateWindow("BUTTON","A#",WS_CHILD |WS_CLIPCHILDREN | BS_BITMAP ,195,0,25,75,window,0,hi,0);
				hBmp_key_A_1_sharp = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\black_shine.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_A_1_sharp,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_A_1_sharp);
				ShowWindow(key_A_1_sharp,i);


		
		key_C_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,30,0,30,130,window,0,hi,0);
				hBmp_key_C_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_C_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_C_1);
				ShowWindow(key_C_1,i);

		key_D_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,60,0,30,130,window,0,hi,0);
				hBmp_key_D_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_D_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_D_1);
				ShowWindow(key_D_1,i);

		key_E_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,90,0,30,130,window,0,hi,0);
				hBmp_key_E_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_E_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_E_1);
				ShowWindow(key_E_1,i);

		key_F_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,120,0,30,130,window,0,hi,0);
				hBmp_key_F_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_F_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_F_1);
				ShowWindow(key_F_1,i);

		key_G_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,150,0,30,130,window,0,hi,0);
				hBmp_key_G_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_G_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_G_1);
				ShowWindow(key_G_1,i);

		key_A_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,180,0,30,130,window,0,hi,0);
				hBmp_key_A_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_A_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_A_1);
				ShowWindow(key_A_1,i);

		key_B_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,210,0,30,130,window,0,hi,0);
				hBmp_key_B_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
				SendMessage(key_B_1,BM_SETIMAGE,IMAGE_BITMAP,(LPARAM)hBmp_key_B_1);
				ShowWindow(key_B_1,i);

		key_B_1_1 = CreateWindow("BUTTON","\nC",WS_CHILD | WS_CLIPSIBLINGS | BS_BITMAP,0,0,30,130,window,0,hi,0);
				hBmp_key_B_1_1 = (HBITMAP)LoadImage(hi,"C:\\AIM_piano\\white.bmp",IMAGE_BITMAP,0,0,LR_LOADFROMFILE);
